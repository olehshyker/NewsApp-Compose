 ...
 */
package com.olehsh.newsapp.data.repository.details
...
class ArticleDetailsRepositoryImpl @Inject constructor(
  ...
  override fun getArticleDetailsById(articleId: String): Flow<NewsArticle> {
    return newsArticlesDao.getArticleDetailsById(articleId).map { it.asDomain() }
  }
}
